...
<template>
   <div class="relative aspect-[16/23] fill-zinc-100">
      <img
         v-if="game.extra.cover"
         :src="game.extra.cover"
         alt="Game Cover"
         class="w-full aspect-[16/23] object-cover"
      />
      <div
         v-else
         class="absolute inset-0 flex items-center justify-center [&>svg]:w-12 [&>svg]:h-12 [&>svg]:fill-inherit"
      >
         <svg
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
            v-if="game.extra.cover === null"
         >
            <path
         ...
         <svg v-else viewBox="0 0 512 512" class="animate-spin">
            <path
